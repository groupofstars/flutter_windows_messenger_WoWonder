...
class Following {
  ...
  final FollowingDetails? details;
  ...
  final String? url;
  final String? name;
  final FollowingApiNotificationSettings? apiNotificationSettings;
  ...
  Following copyWith({
    ...
    String? url,
    String? name,
    FollowingApiNotificationSettings? apiNotificationSettings,
    int? isNotifyStopped,
  ...
  factory Following.fromJson(Map<String, dynamic> json) => Following(
        userId: RobustParser.toStringIt(json["user_id"]),
        username: RobustParser.toStringIt(json["username"]),
        email: json["email"],
        ...
        details: FollowingDetails.fromJson(json["details"]),
        ...
        url: json["url"],
        name: json["name"],
        apiNotificationSettings: FollowingApiNotificationSettings.fromJson(
        ...
        formatedLangs:
            List<String>.from(json["formated_langs"].map((x) => x.toString())),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "formated_langs": List<String>.from(
            formatedLangs?.map((x) => x.toString()).toList() ?? []),
...
@embedded
class FollowingApiNotificationSettings {
  int? eLiked;
  int? eShared;
  int? eWondered;
  int? eCommented;
  ...
  FollowingApiNotificationSettings({
    this.eLiked,
    this.eShared,
    this.eWondered,
    this.eCommented,
  ...
  FollowingApiNotificationSettings copyWith({
    int? eLiked,
    int? eShared,
    int? eWondered,
    int? eCommented,
  ...
  factory FollowingApiNotificationSettings.fromRawJson(String str) =>
      FollowingApiNotificationSettings.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());
  factory FollowingApiNotificationSettings.fromJson(Map<String, dynamic> json) {
    ...
    return FollowingApiNotificationSettings(
      eLiked: parseValue(json['e_liked']),
      eShared: parseValue(json['e_shared']),
      eWondered: parseValue(json['e_wondered']),
      eCommented: parseValue(json['e_commented']),
      eFollowed: parseValue(json['e_followed']),
      eAccepted: parseValue(json['e_accepted']),
      eMentioned: parseValue(json['e_mentioned']),
      eJoinedGroup: parseValue(json['e_joined_group']),
      eLikedPage: parseValue(json['e_liked_page']),
      eVisited: parseValue(json['e_visited']),
      eProfileWallPost: parseValue(json['e_profile_wall_post']),
      eMemory: parseValue(json['e_memory']),
    );
  }
...
class FollowingDetails {
  ...
  factory FollowingDetails.fromRawJson(String str) =>
      FollowingDetails.fromJson(json.decode(str));
...
class LastLoginDataClass {
  ...
  LastLoginDataClass({
    ...
    this.isp,
    this.org,
    this.lastLoginDataAs,
    this.query,
  });

  LastLoginDataClass copyWith({
    String? status,
    String? country,
    String? countryCode,
    String? region,
    ...
    String? query,
      ...
      LastLoginDataClass(
        ...
        isp: isp ?? this.isp,
        org: org ?? this.org,
        lastLoginDataAs: lastLoginDataAs ?? this.lastLoginDataAs,
        query: query ?? this.query,
      );

  factory LastLoginDataClass.fromRawJson(String str) =>
      LastLoginDataClass.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory LastLoginDataClass.fromJson(Map<String, dynamic> json) =>
      LastLoginDataClass(
        status: json["status"],
